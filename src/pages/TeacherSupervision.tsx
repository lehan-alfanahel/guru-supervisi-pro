      ...
      <div className="p-4 space-y-4 max-w-lg mx-auto">
        ...
        <Tabs defaultValue="administrasi">
          ...
          <TabsContent value="administrasi" className="space-y-4 mt-4">
            ...
            {/* ── HASIL PENILAIAN SUPERVISI ADMINISTRASI OLEH KEPALA SEKOLAH ── */}
            <div className="pt-2">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <h2 className="text-base font-bold">Hasil Penilaian Kepala Sekolah</h2>
                  <p className="text-xs text-muted-foreground">Supervisi Administrasi Pembelajaran — {supervisions.length} penilaian</p>
                </div>
              </div>
              {supervisions.length === 0 ? (
                <Card className="border-dashed">
                  <CardContent className="flex flex-col items-center justify-center py-8 text-center">
                    ...
                    <p className="text-sm font-semibold text-muted-foreground">Belum ada hasil penilaian supervisi administrasi</p>
                    <p className="text-xs text-muted-foreground mt-1">Data muncul setelah kepala sekolah melakukan penilaian</p>
                  </CardContent>
                </Card>
              ) : (
                <div className="space-y-3">

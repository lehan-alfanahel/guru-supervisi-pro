        ...
        <div className="flex items-center justify-around px-2 py-2">
          ...
          >
            <div className="relative">
              ...
              {unreadCount > 0 && (
                <span className="absolute -top-1 -right-1.5 w-4 h-4 bg-destructive text-destructive-foreground text-[9px] font-bold rounded flex items-center justify-center leading-none">
